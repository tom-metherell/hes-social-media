...
ggsave("plots/fig2.png", height = 10, width = 15.92, units = "cm", dpi = 600)
```
...
ggsave("plots/fig3.png", height = 10, width = 15.92, units = "cm", dpi = 600)
```
...
ggsave("plots/fig4.png", height = 10, width = 15.92, units = "cm", dpi = 600)
```
